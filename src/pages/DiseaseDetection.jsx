...
function DiseaseDetection() {
  ...
  async function handleSubmit(event) {
    ...
    if (!currentUser) {
      setError(
        "You must be logged in to use disease detection."
      );
      return;
    }
  ...
  function handleViewInformation() {
    ...
    navigate(
      `/remedies-information?disease=${encodeURIComponent(
        result.disease
      )}`
    );
  }
          ...
          {result.disease ? (
            <>
              ...
              <p className="result-disclaimer">
                ...
                result and should not be treated as
            ...
            <>
              <h2>
                No probable disease identified
              </h2>
